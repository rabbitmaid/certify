                    ...
                    @else
                     ...
                     <tr class="hover:bg-gray-50 transition">
                        ...
                        <td>
                            ...
                            <x-badge type="blue"> {{ $submission->status  }} </x-badge>
                            @endif
                        ...
                        <td class="flex items-center justify-end gap-x-2">
                            ...
                            <a href="{{ route('submission.individual', $submission->id) }}" type="submit" class="bg-yellow-500 uppercase  font-semibold text-xs tracking-widest py-1 px-2 rounded text-center hover:bg-yellow-500/80 hover:shadow-sm" title="Generate Certificates">
                                Generate
                            </a>
