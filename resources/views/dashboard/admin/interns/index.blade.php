                                ...
                                <td class="flex items-center justify-center gap-x-2">
                                    ...
                                    @if($intern->status === "pending")
                                        <form action="#" method="POST">
                                            @csrf
                                            <button type="submit" class="bg-green-600 uppercase text-white font-semibold text-xs tracking-widest py-1 px-2 rounded text-center hover:bg-green-600/80 hover:shadow-sm" title="Edit">
                                                Accept
                                            </button>
                                        </form>
                                        ...
                                        <form action="#" method="POST">
                                            @csrf
                                            <button type="submit" class="bg-red-600 uppercase text-white font-semibold text-xs tracking-widest py-1 px-2 rounded text-center hover:bg-red-600/80 hover:shadow-sm" title="Edit">
                                                Reject
                                            </button>
                                        </form>
                                    @endif
