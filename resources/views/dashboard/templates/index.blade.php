                ...
                @foreach ($dbTemplates as $dbTemplate )
                    ...
                    @if($dbTemplate->slug === $template['slug'])  
                        ...
                        <div class="bg-white overflow-hidden shadow-sm rounded-lg pb-5 relative">
                            ...
                            <img src="{{ Storage::disk('template')->url("$screenShotPath") }}" alt="">
                            <div class=" text-gray-900 px-3 my-5">
                                <h2 class="mb-2 text-lg font-semibold">  {{ __($template['name']) }}</h2>
                            ...
                            <div class="px-3 flex justify-start gap-x-2">
                                ...
                                @if($dbTemplate->is_active)
                                    ...
                                    <a href="#" class="bg-blue-500 text-white py-1 px-2 rounded text-center text-sm hover:underline hover:opacity-95 hover:shadow-sm block w-fit flex items-center" title="View">
