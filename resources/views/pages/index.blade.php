<x-page-layout pageTitle="Home">
    ...
    <header class="w-full px-8 xl:px-0">
        @include('pages.partials.navigation')
    </header>

    <section class="w-full mx-auto mb-10 px-8 xl:px-0 py-20 bg-pattern">
        <div class="container mx-auto flex flex-col items-center justify-center">
            ...
            <div class="max-w-3xl">
                ...
                <div class="flex items-center justify-center gap-3">
                    <a href="#" class="text-white bg-blue-600 hover:bg-blue-600 rounded-lg block w-full py-2 px-3 hover:bg-blue-800 transition-all ease-in-out max-w-32 text-center">Apply</a>
