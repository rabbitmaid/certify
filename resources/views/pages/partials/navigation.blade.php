<div class="container max-w-7xl mx-auto lg:flex lg:items-center lg:justify-between lg:gap-3 py-5 text-center">
    ...
    <nav class="w-full flex items-center justify-center gap-5 mb-8 lg:mb-0">
        <a class="text-neutral-200 hover:text-orange-600 font-semibold flex-shrink-0 {{ request()->routeIs('home') ? "text-primary dark:text-secondary" : '' }}" href="{{ route('home') }}">Home</a>
    ...
    <a href="" class="bg-blue-600 hover:bg-blue-800 transition-colors ease-in-out text-white py-2 px-3 rounded-lg w-fit flex-shrink-0">Apply Now</a>
